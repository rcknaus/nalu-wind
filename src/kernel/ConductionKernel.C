...
template <int p> nodal_scalar_array<DoubleType, p> conduction_element_residual<p>::residual(int index,
    ...
    const elem_view::scalar_view<p>& qm1,
    const elem_view::scalar_view<p>& qp0,
...
conduction_element_residual<1>::rhs(int index,
    Kokkos::Array<double, 3> gamma,
    const elem_view::scalar_view<1>& volume,
    const elem_view::scs_vector_view<1>& mapped_area,
    const elem_view::scalar_view<1>& qm1,
    const elem_view::scalar_view<1>& qp0,
