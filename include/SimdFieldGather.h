...
KOKKOS_FORCEINLINE_FUNCTION bool valid_index(int k) { return k != invalid_node_index; }
...
template <int p> void write_to_stk_field(
  ...
  elem_view::scalar_view<p>,
  ScalarFieldType&);

template <int p> elem_view::scalar_view<p> gather_field(const stk::mesh::BulkData&, const stk::mesh::Selector&, const ScalarFieldType&);
template <int p> elem_view::vector_view<p> gather_field(const stk::mesh::BulkData&, const stk::mesh::Selector&, const VectorFieldType&);
